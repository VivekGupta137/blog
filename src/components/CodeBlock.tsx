        ...
        <div className="relative group my-4 sm:my-6 rounded-lg border border-gray-200 bg-white overflow-hidden shadow-sm max-w-full">
            ...
            <div className="flex items-center justify-between bg-gray-50 border-b border-gray-200 px-3 sm:px-4 py-2 sm:py-3">
                ...
                <button
                    ...
                    className="flex items-center gap-1 sm:gap-2 text-gray-500 hover:text-gray-700 transition-all duration-200 opacity-100 sm:opacity-50 group-hover:opacity-100 hover:bg-gray-100 px-1.5 sm:px-2 py-1 rounded-md shrink-0"
                    title="Copy code"
                >
                    {copied ? (
                        <>
