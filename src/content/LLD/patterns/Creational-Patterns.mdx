...
```java
// NotificationService.java highlight=3
...
```java
// EmailNotification.java collapse
...
```java
// NotificationService.java highlight=2,5 
abstract class NotificationService {
...
```
```java
// PushNotification.java collapse
class PushNotification implements Notification {
    public void send(String message) {
